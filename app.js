...
const COALITION_COLORS = {
  ...
  "วุฒิสภา (สายสีน้ำเงิน)": { bg: "#1d4ed8", border: "#1e3a8a", highlight: "#60a5fa" },
  "วุฒิสภา (กลุ่มพันธุ์ใหม่)": { bg: "#059669", border: "#064e3b", highlight: "#34d399" },
  "วุฒิสภา": { bg: "#7c3aed", border: "#5b21b6", highlight: "#a78bfa" },
  "องค์กรอิสระ (กกต.)": { bg: "#d97706", border: "#92400e", highlight: "#fde047" },
  "อดีตวุฒิสภา / ผู้ร้องเรียน": { bg: "#e11d48", border: "#9f1239", highlight: "#fb7185" },
  "ภาคประชาสังคม (iLaw)": { bg: "#0891b2", border: "#155e75", highlight: "#67e8f9" },
  "Government": { bg: "#ef4444", border: "#b91c1c", highlight: "#f87171" },
  "Opposition": { bg: "#f97316", border: "#c2410c", highlight: "#fb923c" },
  "Senate-Blue": { bg: "#1d4ed8", border: "#1e3a8a", highlight: "#60a5fa" },
  "Senate-NewBreed": { bg: "#059669", border: "#064e3b", highlight: "#34d399" },
