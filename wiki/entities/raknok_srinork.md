...
```mermaid
flowchart LR
    curr["รักชนก ศรีนอก"]:::target
    n0["อนุทิน ชาญวีรกูล"] -- "OPPOSITION" --> curr
    curr -- "MEMBER_OF" --> n1["พรรคประชาชน"]
    curr -- "CRITICISM" --> n2["พรรคประชาชน"]
    curr -- "OPPOSITION" --> n3["พรรคภูมิใจไทย"]
