---
id: "tewarit_maneechay"
title: "เทวฤทธิ์ มณีฉาย"
type: "PERSON"
...
<img src="images/avatars/tewarit_maneechay.jpg" alt="เทวฤทธิ์ มณีฉาย" width="120" style="border-radius:50%; margin-bottom:12px;" />
...
```mermaid
flowchart LR
    curr["เทวฤทธิ์ มณีฉาย"]:::target
    curr -- "LEGAL_ACTION" --> n0["ยิ่งชีพ อัชฌานนท์"]
    curr -- "LEGAL_ACTION" --> n1["วุฒิสภา (สว.)"]
    n2["มงคล สุระสัจจะ"] -- "OPPOSITION" --> curr
    n3["นันทนา นันทวโรภาส"] -- "OPPOSITION" --> curr
    curr -- "CRITICISM" --> n4["แสวง บุญมี"]
    curr -- "CRITICISM" --> n5["ศาลรัฐธรรมนูญ"]
    curr -- "CRITICISM" --> n6["คณะกรรมการการเลือกตั้ง (กกต.)"]
    curr -- "CRITICISM" --> n7["คณะกรรมการ ป.ป.ช."]
